...
result = runge_kutta_three_body(
  ...
  r_bx0 = AU, r_by0 = 0, # Earth at 1 AU along x-axis
  r_cx0 = 1.52 * AU, r_cy0 = 0, # Mars at 1.52 AU along x-axis
  v_ax0 = 0, v_ay0 = 0, # Sun stationary
  v_bx0 = 0, v_by0 = V_EARTH_ORBITAL, # Earth moving in +y direction
  v_cx0 = 0, v_cy0 = 24130.772 # Mars orbital velocity in +y direction
)
...
plot(x_a_au, y_a_au, type="l", col="black", lwd=2,
     ...
     xlab="x (AU)", ylab="y (AU)",
     main=sprintf("Earth-Mars-Sun System (Runge-Kutta Method)\nT = %.1f years, N = %d steps",
                  T / YEAR, N))
...
# Add legend
legend("topright", legend=c("Sun", "Earth", "Mars"),
