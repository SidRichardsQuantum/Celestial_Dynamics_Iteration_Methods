...
result = velocity_verlet_two_body(
  T = T,
  N = N,
  m_a = M_EARTH,
  m_b = M_MOON,
...
plot_two_body_result(
  result = result,
  filepath = file.path("images", "two_body", "earth_moon", "earth_moon_velocity_verlet.png"),
  title = sprintf("Earth-Moon System (Velocity Verlet Method)\nT = %.1f lunar months, N = %d steps",
                  T / LUNAR_MONTH, N),
  labels = c("Earth", "Moon"),
  colors = c("blue", "gray")
)
